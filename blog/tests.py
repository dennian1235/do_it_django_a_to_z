...
class TestView(TestCase):
    ...
    def setUp(self):
        ...
        self.user_dennian = User.objects.create_user(username='dennian',
                                                     password='rootroot')
        ...
        self.post_001 = Post.objects.create(
            ...
            author = self.user_dennian
        )
        self.post_001.tags.add(self.tag_hello)

        self.post_002 = Post.objects.create(
            title='두 번째 포스트입니다.',
            content='일등이 전부는 아니잖아요?',
    ...
    def navbar_test(self, soup):
        ...
        logo_btn = navbar.find('a', text='블로그')
    ...
    def test_post_list(self):
        ...
        self.assertIn(self.user_dennian.username.upper(),main_area.text)
...
# Create your tests here.
    ...
    def test_create_post(self):
        ...
        self.client.login(username='dennian', password='rootroot')
        response = self.client.get('/blog/create_post/')
        self.assertNotEqual(response.status_code, 200)
        ...
        self.assertIn(last_post.author.username, 'obama')
    ...
    def test_update_post(self):
        ...
        self.assertNotEqual(self.post_003.author, self.user_dennian)
        self.client.login(
            username=self.user_dennian.username,
            password = 'rootroot'
        )
        response = self.client.get(update_post_url)
